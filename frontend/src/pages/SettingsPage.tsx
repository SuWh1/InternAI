...
import { ArrowLeft, User, Lock, Settings, Target } from 'lucide-react';
...
type SettingsSection = 'profile' | 'onboarding' | 'password';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center space-x-3">
            <div className="p-2 bg-theme-hover rounded-lg border border-theme shadow-sm">
              <Settings className="w-6 h-6 text-theme-primary dark:text-purple-400" />
            </div>
            <div>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-80 flex-shrink-0">
            <div className="bg-theme-secondary rounded-xl shadow-sm border border-theme overflow-hidden">
              <div className="p-4 border-b border-theme bg-theme-hover dark:bg-purple-900/20">
                  ...
                  return (
                    <button
                      ...
                      className={`w-full text-left p-3 rounded-lg transition-all duration-200 group ${
                        isActive
                          ? 'bg-theme-hover dark:bg-purple-900/30 text-theme-primary'
                    ...
                    >
                      <div className="flex items-start space-x-3">
                        <Icon className={`w-5 h-5 mt-0.5 ${
                          isActive 
                            ? 'text-theme-primary dark:text-purple-400' 
                        ...
                        <div>
                          ...
                          <div className={`text-sm ${
                            isActive 
                              ? 'text-theme-secondary dark:text-purple-300' 
                              : 'text-gray-600 dark:text-theme-secondary'
                          }`}>
                            {section.description}
                          </div>
                        </div>
